    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white dark:bg-gray-800">
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-6">Editar funcionário</h1>
                ...
                <form action="{{ route('funcionarios.update', $funcionario->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="contratacao" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Contratação:</label>
                        <input type="text" name="contratacao" id="contratacao" class="form-input mt-1 block w-full" value="{{ $funcionario->contratacao }}" required>
                    </div>
